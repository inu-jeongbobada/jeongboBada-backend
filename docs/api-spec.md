...
| PATCH  | /api/professors/{professorId}/professor-comments/{professorCommentId} | 교수 댓글 수정 | { <br/> "professorCommentRate": 0, <br/> "professorCommentDetail": "\~", <br/> "professorCommentAnonymity": "TRUE or FALSE" <br/>} | { <br/> "message": "댓글 수정이 완료되었습니다." <br/>} | 미구현 |
