...
|--------|-----------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----|
| GET    | /api/professors                                                       | 교수 목록 조회 | N/A                                                                                                                  | [{ <br/> "professorId": 0, <br/> "professorName": "OOO", <br/> "professorImageUrl": "https://...", <br/> "labLists": [{ <br/>"labId": 0, <br/> "labName": "OOOOO", <br/> "labUrl": "https://..." <br/>}]<br/>}]                                                                                                                                                                                                                                                                                   | 미구현 |
| GET    | /api/professors/{professorId}                                         | 교수 상세 조회 | N/A                                                                                                                  | { <br/> "professorName": "OOO", <br/> "professorImageUrl": https://...", <br/> "professorDetail": "\~", <br/> "labDetails": [{ <br/>"labId": 0, <br/> "labName": "OOOOO", <br/> "labUrl": "https://...", <br/> "labDetail": "\~" <br/>}], <br/> "professorCommentDetails": [{ <br/> "professorCommentId": 0, <br/> "professorCommentDetail": "\~", <br/> "professorCommentRate": 0, <br/> "professorCommentDate": "YYYY-MM-DD", <br/> "professorCommentAnonymity": "True or False" <br/>}] <br/>} | 미구현 |
