...
public enum GlobalErrorCode implements BaseErrorCode {
    ...
    API_NOT_FOUND(HttpStatus.NOT_FOUND, "API_NOT_FOUND", "요청하신 경로를 찾을 수 없습니다"), // 404
    ...
    AUTHENTICATION_REQUIRED(HttpStatus.UNAUTHORIZED, "AUTHENTICATION_REQUIRED", "인증이 필요합니다"), // 401
    ...
    // 단, 평소에는 상수 이름과 code를 같게 둔다(검색·리뷰 편의, #131) — ErrorCodeRulesTest가 검사한다.
    // 이미 배포된 code를 유지한 채 상수 이름만 바꿔야 할 때만 둘을 다르게 하고, 그 테스트의 예외 목록에 등록한다.
    // 기현-생각
